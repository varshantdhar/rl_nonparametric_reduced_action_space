...
class QLearning_Agent(object):
	...
	def step(self, a, context, env):
		...
		learner = DQN.Q_Learning(0.5, 0.99, val_model, targ_model, actions, state_size=context_dim)
		return DQN.get_reward(env, learner, context)
