...
class Bandit(abc.ABC, object):
    ...
    def play_arm(self, a, t, env, dqn_agent, target_network, context, prev_reward=None, prev_action=None, prev_state=None):
        ...
        rew, prev_action, prev_state = DRRN.train(dqn_agent, target_network, context, env, a, prev_reward, prev_action, prev_state)
