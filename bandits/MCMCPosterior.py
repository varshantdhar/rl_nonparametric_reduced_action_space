...
class MCMCPosterior(object):
    ...
    def update_reward_posterior_params(self, how, a, k, x, y):
        ...
        if how == 'add':
            ...
            # if post <= 0:
            print('Old Beta: {}, New Beta: {}, Sigma_Inv: {}, Sigma: {}, Theta: {}, x1: {}, x2: {}'.format(prior, post, sigma_inv, self.reward_posterior['Sigma'][a], self.reward_posterior['theta'][a,k]), x[:,None], x[None,:])
        else:
